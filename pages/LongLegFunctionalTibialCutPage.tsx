...
const CuttingBlock: React.FC<{
    ...
    >
        ...
        <svg viewBox="0 0 320 130" className={`w-full h-auto max-h-[6.875rem] ${isSelected ? 'drop-shadow-[0_0_10px_rgba(109,40,44,0.6)]' : 'drop-shadow-lg'}`}>
            <defs>
...
const LongLegFunctionalTibialCutPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (longLegFunctionalCutDegree === null || longLegFunctionalCutDegree === undefined) {
            ...
            setLongLegFunctionalCutDegree(newDefault);
        }
            ...
            <div className="flex flex-col flex-grow relative min-h-0 px-1 relative z-10 overflow-visible lg:overflow-hidden">
                ...
                <div className="flex-grow grid grid-cols-1 lg:grid-cols-[1fr_1.5fr_1fr] gap-4 min-h-0 overflow-visible lg:overflow-hidden mt-1 pb-4">
                    ...
                    <div className="h-full flex flex-col min-h-0 overflow-visible lg:overflow-hidden">
                        <div className="relative bg-[#1a1a1a] border border-[#333333] rounded-xl shadow-inner h-full flex flex-col overflow-visible lg:overflow-hidden">
                            <div className="absolute inset-0 bg-noise opacity-[0.02] pointer-events-none rounded-xl" />
                            ...
                            <div className="p-0.5 flex-grow flex flex-col justify-evenly items-center h-full overflow-hidden relative z-10">
                                <p className="text-center text-gray-500 text-[0.625rem] mb-0 shrink-0">Click block to simulate</p>
