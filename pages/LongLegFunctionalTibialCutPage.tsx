...
const LongLegFunctionalTibialCutPage: React.FC = () => {
    ...
    useEffect(() => {
        if (!longLegFunctionalTibialCutImage) {
            setLongLegFunctionalTibialCutImage('/tibiacut.png');
        }
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-1 no-print shrink-0">
                ...
                <button onClick={() => setPage('planner-long-leg-coronal-balancing')} className="gemini-dark-button font-bold py-2 px-4 rounded-md transition text-sm flex items-center space-x-2">
                ...
                <div className="flex-grow grid grid-cols-1 lg:grid-cols-3 gap-4 min-h-0">
                    ...
                    <div className="h-full">
                        <div className="bg-gray-900/40 border-2 border-gray-700 rounded-xl shadow-inner h-full flex flex-col p-2 space-y-2 overflow-y-auto">
                            <div className="gemini-dark-card p-3 rounded-xl border-l-4 border-[#6D282C] hover:bg-[#2a2b2c] transition-colors flex-1 flex flex-col justify-center items-center text-center gap-2">
                                <div className="bg-[#6D282C] text-white w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center text-lg font-bold shadow-lg border-2 border-red-900">
                                    1
                                </div>
                            ...
                            <div className="bg-gray-800 border-2 border-gray-600 rounded-xl p-3 text-center shadow-lg mt-auto">
                                <p className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-1">Anticipated Tibia Cut</p>
                            ...
                            <div className="bg-gray-800/60 border border-gray-600 rounded-xl p-3 flex flex-col items-center gap-2">
                                <p className="text-gray-400 text-xs text-center">Laxity Status: <span className="text-white font-bold">{lateralLaxity || 'Unknown'}</span></p>
                                <button
                                    onClick={applyLateralLaxity}
                                    className="w-full bg-red-900 hover:bg-red-800 text-white font-bold py-2 rounded-lg shadow-lg transition-colors text-sm"
                                >
                    ...
                    <div className="flex flex-col h-full items-center justify-center relative p-0 overflow-hidden">
                        ...
                        >
                            ...
                            <div className="absolute top-4 right-4 z-40 bg-gray-900/90 backdrop-blur-xl border-2 border-[#8B0000] rounded-2xl px-4 py-3 text-center shadow-[0_0_30px_rgba(139,0,0,0.3)] pointer-events-none min-w-[100px] transform transition-transform hover:scale-105">
                                <p className="text-[10px] text-red-300 uppercase font-extrabold tracking-widest mb-1 shadow-black drop-shadow-md">Medial Gap</p>
                                <p className="text-3xl font-black text-red-100 leading-none drop-shadow-xl">{medialGapValue} <span className="text-sm text-red-300 font-bold">mm</span></p>
                            </div>
                            ...
                            {/* Image Layer */}
                            <img src="/tibiacut.png" alt="X-ray Reference" className="w-full h-full object-contain pointer-events-none" />
                                ...
                                <div className="flex-1 w-full flex items-center justify-center mb-1">
                                    ...
                                    >
                                        {currentRecommendation === 0 && (
                                            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 bg-green-700 text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full shadow-lg z-20 whitespace-nowrap tracking-wider">
                                                RECOMMENDED
                                            </div>
                                        )}
                                        <span>0 DEGREE</span>
