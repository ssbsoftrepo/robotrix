                            ...
                            <div className="flex items-center gap-8 mb-6">
                                <div className="text-center">
                                    ...
                                    <div className="w-20 h-20 rounded-full border-4 border-[#333333] flex items-center justify-center bg-black/40">
                                        <span className="text-2xl font-black text-gray-300">{cpak ?? '--'}</span>
                                    </div>
                                </div>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className={`w-20 h-20 rounded-full border-4 flex items-center justify-center bg-black/40 ${simulatedCPAK === cpak ? 'border-green-500' : 'border-amber-500'}`}>
                                        <span className={`text-2xl font-black ${simulatedCPAK === cpak ? 'text-green-500' : 'text-amber-500'}`}>{simulatedCPAK}</span>
                                    </div>
                                </div>
                            </div>

                            <div className={`w-full p-3 rounded-lg border flex items-center justify-center gap-2 ${simulatedCPAK === cpak ? 'bg-green-500/10 border-green-500/30' : 'bg-amber-500/10 border-amber-500/30'}`}>
                                <div className={`w-3 h-3 rounded-full ${simulatedCPAK === cpak ? 'bg-green-500' : 'bg-amber-500'}`}></div>
                                <p className={`text-xs font-bold ${simulatedCPAK === cpak ? 'text-green-500' : 'text-amber-500'}`}>
                                    {simulatedCPAK === cpak ? 'CPAK Phenotype Successfully Retained' : 'CPAK Phenotype Shift Detected'}
                                </p>
                            </div>
