...
const ValgusPreOpReportPage: React.FC = () => {
    const {
        patients,
        currentPatientId,
        valgusCanvasDataUrl,
        ...
        if (typeof tibiaCutBg === 'string' && !tibiaCutBg.startsWith('data:')) {
            ...
            img.onload = () => {
                ...
                if (ctx) {
                    ...
                    try {
                        setBase64TibiaBg(canvas.toDataURL('image/jpeg'));
                    } catch (e) {
    ...
    const handlePrint = () => {
        ...
        printCurrentPage('Robotrix_Valgus_PreOp_Report');
    };
...
export default ValgusPreOpReportPage;
