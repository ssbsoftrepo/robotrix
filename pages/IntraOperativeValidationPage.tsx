        ...
        <div className="relative flex flex-col h-full overflow-y-auto lg:overflow-hidden bg-gradient-to-br from-[#1E1E1E] to-[#121212]">
            ...
            <div className="flex-grow grid grid-cols-1 lg:grid-cols-[22fr_52fr_26fr] gap-4 min-h-0 px-2 relative z-10 overflow-visible lg:overflow-hidden pb-4">
                    ...
                    <div className="flex flex-col gap-3 flex-grow min-h-0">
                        <div className="relative bg-[#2a2a2a]/60 p-2 rounded-xl border-l-4 border-[#6D282C] flex flex-col gap-2 flex-[1] min-h-0 shadow-lg justify-center items-center">
                            <div className="flex items-start gap-2 w-full">
                                ...
                                <p className="text-sm md:text-base font-bold text-gray-300 leading-snug w-full uppercase">Use Robotrix AI Blocks (Asymmetrical incremental) to gauge Medial and Lateral extension gaps</p>
                            </div>
                        ...
                        <div className="relative bg-[#2a2a2a]/60 p-2 rounded-xl border-l-4 border-[#6D282C] flex flex-col gap-2 flex-[1] min-h-0 shadow-lg justify-center items-center">
                            <div className="flex items-start gap-2 w-full">
                                ...
                                <p className="text-sm md:text-base font-bold text-gray-300 leading-snug w-full uppercase">Measure Mid Mediolateral Tibial width using tibial callipers</p>
                            </div>
                ...
                <div className="h-full flex flex-col gap-1 overflow-visible lg:overflow-hidden min-h-[25rem] lg:min-h-0">
                    <div className="relative flex-grow bg-[#1a1a1a] border border-[#333333] rounded-xl flex items-stretch p-2 overflow-hidden">
                        ...
                        {/* Center - Bone Image */}
                        <div className="flex-grow flex items-center justify-center z-10 min-w-0 px-2 h-full">
                ...
                <div className="h-full flex flex-col gap-2 overflow-visible lg:overflow-hidden">
                    ...
                    <div className="bg-[#1a1a1a] border border-[#333333] pt-2 pb-2 px-2 rounded-xl flex flex-col flex-[45] min-h-0 justify-center relative mt-2">
                        <div className="absolute top-0 inset-x-0 w-full flex justify-center mt-2 z-10">
                            <span className="px-4 py-2 rounded-sm text-xs font-black bg-[#6D282C] text-white shadow-lg tracking-widest uppercase border border-[#893338]">ENTER ACTUAL GAPS</span>
                        </div>
                                ...
                                <div className="space-y-1 px-1">
                                    {[
                                        ...
                                        <div key={index} className="flex items-center gap-2 bg-[#1a1a1a] p-2 rounded border border-[#333333]">
                                            ...
                                            <span className="text-gray-300 text-xs font-medium leading-tight uppercase">{item}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
